$(`<img src="https://j.top4top.io/p_1602euiov1.gif" class="fr" style="width:100%;margin-top:0;" >

`).insertBefore('.nav-tabs');$("<div class='fr borderg' style='padding:2px;background-color:white;float:left;margin-left:4px;'> جوال:<a href='https://www.jawalhost.com/'>هوست</a></div>").insertAfter($(".loginstat"));$(`<link rel="stylesheet" type="text/css" href=""><style>button.btn.fr.btn-success.fa.fa-refresh{display:none}
a.label.label-primary.fl img.fl{display:none}
a.label.label-primary.fl{background-image:url(https://l.top4top.io/p_1602g2n802.png);background-size:cover;width:100%!important;padding:6px!important;border-radius:0!important;text-align:center!important}
a.label.label-primary.fl,.colorStyle{color:#750E0E!important}
#des22{text-align:center!important;font-size:100%!important}
label.fl.label.loginstat{background-color:#750e0e!important;position:absolute;top:35px;margin-top:4px;left:-2px;border-radius:11px 44px 133px 5px!important}
...
div#tlogins::-webkit-scrollbar-thumb{background:0 0;border:71px #fff;border-radius:31px}
div#tlogins::-webkit-scrollbar-thumb:active{background:0 0}
div#tlogins::-webkit-scrollbar-track{background:#fff;border:65px #fff;border-radius:34px}
div#tlogins::-webkit-scrollbar-track:hover{background:0 0}
div#tlogins::-webkit-scrollbar-track:active{background:0 0}
div#tlogins::-webkit-scrollbar-corner{background:0 0}
div#tlogins .fl.mini.u-msg{margin-top:3px!important;border-radius:3px!important}
#d2{height:782px;background-image:url(https://k.top4top.io/p_1602qk52k1.png)!important;background-size:contain;background-repeat:no-repeat;background-position:50%}
a.label.label-primary.fl img.fl,button.btn.fr.btn-success.fa.fa-refresh,div#l2 br,div#l3 br{display:none}
.label-primary,.btn-primary{background-color:#750E0E!important}
</style>`).insertBefore('body');bct=100;msgt=100;vchat=false;
$(document.getElementById("tbox").placeholder = "  　　　 حيـاكم شَــات  زهــرة أللوتـس ");
